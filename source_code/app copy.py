...
model_path = "Model/car-prediction.model"
scalar_path = "Model/car-scalar.model"
label_path = "Model/car-label.model"
brand_label = "Model/brand-label.model"
brand_fuel = "Model/brand-fuel.model"
rf_Model = "Model/feature_importance.model;"
...
card_manufacturer = dbc.Card([
    dbc.CardBody(
        [
            html.H5(children='Please select the brand of the car', style={'text-align': 'center', 'color':'white', 'background-color': 'blue'}),
...
card_year = dbc.Card([
    dbc.CardBody(
        [
            html.H5(children='Please select the year of manufacture', style={'text-align': 'center', 'color':'white', 'background-color': 'blue'}),
...
card_fuel_type = dbc.Card([
    dbc.CardBody(
        [
            html.H5(children='Please select the fuel type of the car', style={'text-align': 'center', 'color':'white', 'background-color': 'blue'}),
...
card_mileage_reading = dbc.Card([
    dbc.CardBody(
        [
            html.H5(children='Please enter the milaege of the car', style={'text-align': 'center', 'color':'white', 'background-color': 'blue'}),
...
card_power_reading = dbc.Card([
    dbc.CardBody(
        [
            html.H5(children='Please enter the maximum power of the car', style={'text-align': 'center', 'color':'white', 'background-color': 'blue'}),
...
app.layout = dbc.Container([
    dcc.Tab(label="Prediction", children=[
                        dbc.Container([
                            html.Br(),
                            html.H1(children='Welcome to Chaky Car Company ', style={'text-align': 'center', 'color':'red'}),
                            html.H3(children='We predict car-prices based on varierty of features', style={'text-align': 'center', 'color':'white', 'background-color': 'blue'}),
                            html.H3(children='Please input only those fields that you are familiar with. To ensure accuracy, we fill the null fields with the mean/median/mode values based on our analysis', style={'text-align': 'center', 'color':'white', 'background-color': 'blue'}),
                            ...
                            html.Br(),
                            html.H4(children='As the model has around 93% accuracy the upper and lower range of price has also been provided', style={'text-align': 'center', 'color':'red'}),
